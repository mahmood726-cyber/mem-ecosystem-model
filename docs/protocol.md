        # Mem Ecosystem Model: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/mem-ecosystem-model.git

        ## Objective

        MEM (Meta-Ecosystem Model) models the ecology of evidence production across a clinical field, tracking evidence accumulation, decay, and synthesis gaps over time, targeting PLOS ONE.
        ...
        - Code: https://github.com/mahmood726-cyber/mem-ecosystem-model.git
        - Dashboard: https://mahmood726-cyber.github.io/mem-ecosystem-model/
